...
public class GraficosPlace extends SimcePlace {

	public GraficosPlace() {
		super();
	}
	
	public GraficosPlace(int aplicacionId, int nivelId, int tipoId) {
		super(aplicacionId, nivelId, tipoId);
	}
	
	@Prefix("graficos")
	public static class Tokenizer implements PlaceTokenizer<GraficosPlace>{

		@Override
		public GraficosPlace getPlace(String token) {
			HashMap<String, String> kvs = TokenUtils.getTokenValues(token);
			GraficosPlace pp = new GraficosPlace();
		...
		@Override
		public String getToken(GraficosPlace place) {
