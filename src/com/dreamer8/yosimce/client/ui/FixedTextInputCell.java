...
public class FixedTextInputCell extends AbstractInputCell<String, FixedTextInputCell.ViewData> {
	interface Template extends SafeHtmlTemplates {
	    @Template("<input type=\"text\" value=\"{0}\" tabindex=\"-1\" style=\"width:{1}px\"></input>")
	   ...
	   */
	  public FixedTextInputCell() {
	    super(BrowserEvents.CHANGE, BrowserEvents.KEYUP, BrowserEvents.KEYDOWN);
	    if (template == null) {
	      template = GWT.create(Template.class);
	    }
	  }
	  
	  public FixedTextInputCell(int width) {
		    this();
		    this.width = width;   
		  }
	   ...
	   */
	  @Deprecated
	  public FixedTextInputCell(SafeHtmlRenderer<String> renderer) {
	    this();
	  }
	  ...
	  public void render(Context context, String value, SafeHtmlBuilder sb) {
	    ...
	    if (s != null) {
	      sb.append(template.input(s,""+width));
	    } else {
	      sb.appendHtmlConstant("<input type=\"text\" tabindex=\"-1\" style=\"width:"+width+"px\"></input>");
	    }
	  }
