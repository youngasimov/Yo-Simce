...
public class ActividadDAO extends AbstractHibernateDAO<Actividad, Integer> {
	...
	public List<AgendaPreviewDTO> findAgendasByIdAplicacionANDIdNivelANDIdActividadTipoANDFiltros(Integer idAplicacion, Integer idNivel,
		...
		for (Object[] o : os) {
			...
			apdto.setCodigoPisa((String) o[35]);
			apdtos.add(apdto);
		}
	...
	public List<ActividadPreviewDTO> findActividadesByIdAplicacionANDIdNivelANDIdActividadTipoANDFiltros(Integer idAplicacion, Integer idNivel,
		...
		// if (idAplicacion == 2) {
		// query +=
		// " LEFT JOIN (SELECT actividad_id,COUNT(documento_id) AS total_sinc FROM pendrive_sinc "
		...
		for (Object[] o : os) {
			...
			// apdto.setCuestionariosPadresApoderadosRecibidosAplicados((o[37]
			// == null) ? 0
