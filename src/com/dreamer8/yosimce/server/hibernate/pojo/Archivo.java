...
public class Archivo implements java.io.Serializable {
	...
	public Archivo(Integer id, String titulo, Date fechaPublicacion,
			String rutaArchivo, boolean visible, String mimeType,
			String ipServer, List<GuiaDespacho> guiaDespachos, List<Documento> documentos,
