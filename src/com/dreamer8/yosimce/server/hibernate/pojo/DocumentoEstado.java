...
public class DocumentoEstado implements java.io.Serializable {
	 ...
	 * @return
	 */
	public EstadoSincronizacionDTO getEstadoSincrinizacion() {
		EstadoSincronizacionDTO esdto = new EstadoSincronizacionDTO();
		esdto.setIdEstadoSincronizacion(id);
		esdto.setNombreEstado(nombre);
		return esdto;
	}
