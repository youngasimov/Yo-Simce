...
public class Actividad implements java.io.Serializable {
	...
	/**
	 * @return the materialContingencia
	 */
	public boolean isMaterialContingencia() {
		return materialContingencia;
	}

	/**
	 * @param materialContingencia
	 *            the materialContingencia to set
	 */
	...
	public AgendaPreviewDTO getAgendaPreviewDTO(Session s, Integer idAplicacion) {
		...
		apdto.setCodigoPisa(curso.getEstablecimiento().getCodigo());
	...
	public ActividadDTO getActividadDTO(Session s, Integer idAplicacion,
		...
		ArrayList<ContingenciaDTO> cdtos = new ArrayList<ContingenciaDTO>();
		if (axis != null && !axis.isEmpty()) {
			for (ActividadXIncidencia axi : axis) {
				cdtos.add(axi.getContingenciaDTO());
			}
		}
		...
		if (axdt != null) {
			adto.setTotalCuestionarios(axdt.getTotal());
			adto.setCuestionariosEntregados(axdt.getTotalEntregados());
