...
public class UsuarioTipo implements java.io.Serializable {
	...
	public UsuarioTipo(Integer id, UsuarioTipo usuarioTipo, String nombre,
			boolean firmaContrato, Integer ccCapacidad, String rol,
			List<CcCapacitacion> ccCapacitacions, List<FaseXAplicacionXTestXNivelXUsuarioTipo> faseXAplicacionXTestXNivelXUsuarioTipos,
			List<AplicacionXNivelXUsuarioTipo> aplicacionXNivelXUsuarioTipos, List<UsuarioPreseleccion> usuarioPreseleccions,
			List<AplicacionXUsuarioTipo> aplicacionXUsuarioTipos, List<UsuarioTipo> usuarioTipos, List<UsuarioSeleccion> usuarioSeleccions) {
		this.id = id;
