...
public class Material implements java.io.Serializable {
	...
	private List<MaterialHistorial> materialHistorials = new ArrayList<MaterialHistorial>(
			0);
	private List<MaterialXGuiaDespacho> materialXGuiaDespachos = new ArrayList<MaterialXGuiaDespacho>(
			0);
	...
	public Material(Integer id, Co co, MaterialTipo materialTipo,
			String codigo, List<Cc> ccs, List<Lote> lotes,
			List<Actividad> actividads, List<Documento> documentos,
			List<MaterialHistorial> materialHistorials,
			List<MaterialXGuiaDespacho> materialXGuiaDespachos) {
		this.id = id;
		this.co = co;
	...
	public void setMaterialXGuiaDespachos(
			List<MaterialXGuiaDespacho> materialXGuiaDespachos) {
		this.materialXGuiaDespachos = materialXGuiaDespachos;
	}
